package test.java.org.yasin.infonal.data.driver.mongodb;

import java.security.InvalidParameterException;

import main.java.org.yasin.infonal.data.driver.mongodb.MongoDBDriverConnectionStringPattern;
import main.java.org.yasin.infonal.data.driver.mongodb.MongoDBDriverParams;
...
public class MongoDBDriverConnectionStringPatternTest extends TestCase {
	...
	public void testParseParams1() {
		...
		MongoDBDriverConnectionStringPattern connectionStringPattern = MongoDBDriverConnectionStringPattern.PATTERN_ONE;
		...
		MongoDBDriverParams params = connectionStringPattern
				.parseForPatternOne(correctConnectionString);
	...
	public void testParseParams2() {
		...
		MongoDBDriverConnectionStringPattern connectionStringPattern = MongoDBDriverConnectionStringPattern.PATTERN_TWO;
		...
		MongoDBDriverParams params = connectionStringPattern
				.parseForPatternTwo(correctConnectionString);
		assertEquals(params.getDbHost(), "127.0.0.1");
		assertEquals(params.getDbName(), "dbname");
