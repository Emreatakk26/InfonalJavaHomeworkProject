package test.java.org.yasin.infonal.util;

import main.java.org.yasin.infonal.util.StringUtil;
import junit.framework.TestCase;

public class StringUtilTest extends TestCase {

	public void testToStringCorrectValues() {

		assertEquals("00", StringUtil.intToString(0, 2));
		assertEquals("99", StringUtil.intToString(99, 2));
	}

	public void testIntToStringException1() {
		try {
		...
		try {
			...
			assertTrue(ex.getLocalizedMessage().contains(
					"Digits must be bigger then zero"));
		}
