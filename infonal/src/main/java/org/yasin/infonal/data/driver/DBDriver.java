...
public abstract class DBDriver {
	...
	abstract public void checkConnectionStringSyntax()
			throws ConnectionStringSyntaxException;
	...
	/*****************************************
	 * Select the fields of a table. You must call this method before
	 * get(tableName) method
	 * 
	 * @param fields
	 */
	...
	/*****************************************
	 * Get data from a table. You have to call dbDriver.from(tableName) method
	 * before call this.
	 * 
	 * @return
	 */
	...
	/*****************************************
	 * Example usage: dbDriver.select(Arrays.asList({"*", "id", "username",
	 * "firstname"}));
	 * 
	 * DBDataObject dbDataObject = new DBDataObject();
	 * dbDataObject.getValues.put("firstname", "yasin%");
	 * 
	 * dbDriver.where(dbDataObject); dbDriver.from("userstable");
	 * 
	...
	abstract public void uptade(String tableName, DBDataObject data) throws DBDriverProcessException;
